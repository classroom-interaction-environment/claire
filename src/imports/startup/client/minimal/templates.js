...
TemplateLoader.enable()
	.register(
		"routeInfo",
		async () => import("../../../ui/layout/routeInfo/routeInfo"),
	)
	.register(
		"docnotfound",
		async () => import("../../../ui/generic/docnotfound/docnotfound"),
	)
	.register(
		"disconnected",
		async () => import("../../../ui/generic/disconnected/disconnected"),
	)
	.register(
		"actionButton",
		async () => import("../../../ui/generic/actionbutton/actionbutton"),
	)
	.register(
		"routeButton",
		async () => import("../../../ui/generic/routebutton/routebutton"),
	)
	...
	.register(
		"tooltip",
		async () => import("../../../ui/generic/tooltip/tooltip"),
	)
...
/**
 * @param options
 * @param options.contexts
 * @param options.loaders
 * @param options.language
 * @param options.debug
 * @param options.useForms
...
Template.prototype.setDependencies = function (options = {}) {
	...
	if (completeStates.has(viewName)) {
		throw new Error(
			"Template setDependencies called multiple times. This should never occur.",
		);
	}
