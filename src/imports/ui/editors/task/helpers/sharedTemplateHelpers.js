...
Template.registerHelper("taskPageContentType", () =>
	TaskDefinitions.helpers.contentTypes(),
);

Template.registerHelper(
	"taskPageMetaType",
	(contentType, subcategoryFilter) => {
...
Template.registerHelper("taskPageSubcategories", (contentType) => {
	check(contentType, String);
	const subCategories =
		TaskDefinitions.helpers.getSubtypeCategories(contentType);
	if (!subCategories || !subCategories.length) return;
	return subCategories;
});

Template.registerHelper("taskPageContentIcon", (key) =>
	TaskDefinitions.helpers.contentIcon(key),
);
...
Template.registerHelper("taskPageContentLabel", (key) =>
	TaskDefinitions.helpers.contentLabel(key),
);

Template.registerHelper("taskPageMetaLabel", (contentKey, metaKey) =>
	TaskDefinitions.helpers.metaLabel(contentKey, metaKey),
);
