...
LessonActions.start = ({ _id, failure, success }) =>
	callMethod({
...
LessonActions.complete = ({ _id, failure, success }) =>
	callMethod({
...
LessonActions.restart = ({ _id, failure, success }) =>
	callMethod({
...
LessonActions.toggle = ({ _id, referenceId, context }, callback) =>
	Meteor.call(
		Lesson.methods.toggle.name,
		{
			_id,
			referenceId,
			context,
