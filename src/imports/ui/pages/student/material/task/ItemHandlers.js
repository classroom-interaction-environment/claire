...
ItemHandlers.onTaskPagePrev = ({ instance, onError }) =>
	function onTaskPagePrev({ page, maxPages, taskId }) {
		window.scrollTo(0, 0);
...
ItemHandlers.onTaskPageNext = ({ instance, onError }) =>
	function onTaskPageNext({ page, maxPages, taskId }) {
		window.scrollTo(0, 0);
...
ItemHandlers.onTaskFinished = ({ instance, onError }) =>
	function onTaskFinished({ page, taskId }) {
		window.scrollTo(0, 0);
		saveTask({
			lessonDoc: instance.state.get("lessonDoc"),
			groupDoc: instance.state.get("groupDoc"),
