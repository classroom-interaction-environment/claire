...
export const isIn = (a, b) =>
	(Array.isArray(b) || typeof b === "string") && b.indexOf(a) > -1;
...
export const stringify = (obj, replacer = null, space = 2) =>
...
export const toUser = (userId) =>
	getUser(userId) || { _id: userId, username: userId };

export const isOnline = (presence = {}) =>
	presence.isOnline || presence?.status === "online";
