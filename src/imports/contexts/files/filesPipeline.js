...
export const filesPipeline = createPipeline(Files.name, (filesContext, api) => {
	filesContext.schema = Object.assign(
		{},
		filesContext.schema,
		FilesDefaults.schema(),
	);
	filesContext.publicFields = Object.assign(
		{},
		filesContext.publicFields,
		FilesDefaults.fields(),
	);
	filesContext.methods = filesContext.methods || {};
	filesContext.methods.setMasterState = createSetStateMethod(filesContext, {
		type: "master",
	});
	filesContext.methods.setCustomState = createSetStateMethod(filesContext, {
		type: "custom",
	});
