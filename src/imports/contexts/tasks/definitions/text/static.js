...
const alignmentOptions = Object.values(Alignment).map((el) => ({
	value: el.class,
	label: el.label,
}));
			...
			autoform: {
				...
				options() {
					return [
						{
							value: 1,
							label: i18n.get("text.headline.h1"),
						},
						{
							value: 2,
							label: i18n.get("text.headline.h2"),
						},
						{
							value: 3,
							label: i18n.get("text.headline.h3"),
						},
						{
							value: 4,
							label: i18n.get("text.headline.h4"),
						},
						{
							value: 5,
							label: i18n.get("text.headline.h5"),
						},
						{
							value: 6,
							label: i18n.get("text.headline.h6"),
						},
					];
				},
			},
