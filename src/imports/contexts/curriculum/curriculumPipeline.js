...
const assignSchema = (expected, fallback = {}) =>
	Object.assign({}, Schema.getDefault(), expected || fallback);
...
export const curriculumPipeline = createPipeline(Curriculum.name, (context) => {
	...
	context.publicFields = Object.assign(
		{},
		Defaults.fields(),
		Curriculum.getDefaultPublicFields(),
		context.publicFields,
	); // TODO why not curriculum.getDefaultFields() ?
	...
	context.publications = Object.assign(
		{},
