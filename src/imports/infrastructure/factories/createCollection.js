...
export const createCollection = (
	...
	{ connection, idGeneration, transform, defineMutationMethods } = {},
) => {
	...
	if (defineMutationMethods)
		options.defineMutationMethods = defineMutationMethods;
