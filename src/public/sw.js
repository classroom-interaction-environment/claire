...
const isRangeRequest = request => (request.headers.get('range') || '').includes('bytes=')

self.addEventListener('fetch', (event) => {
  // prefer a high compatibility with range requests and partial response
  // in favor of any caching or other performance improvements
